...
import TemplateUtils, { type TemplateConfig, type ToolConfig } from '../TemplateUtils.js';
...
describe('TemplateUtils', () => {
  ...
  describe('getJsTemplateOrValueConfig', () => {
    ...
    it('should return null/undefined as-is', () => {
      ...
      expect(
        TemplateUtils.getJsTemplateOrValueConfig(mockTool, mockEntities, undefined)
      ).toBeUndefined();
    });
