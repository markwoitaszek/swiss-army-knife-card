...
// Tuesday, August 10
export const formatDateWeekdayDay = (dateObj, locale) =>
...
// August 2021
export const formatDateMonthYear = (dateObj, locale) =>
...
// mo
export const formatDateWeekdayShort = (dateObj, locale) =>
  formatDateWeekdayShortMem(locale).format(dateObj);
